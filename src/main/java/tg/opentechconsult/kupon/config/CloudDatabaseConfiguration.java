package tg.opentechconsult.kupon.config;
...
@Configuration
@EnableMongoRepositories("tg.opentechconsult.kupon.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("tg.opentechconsult.kupon.config.dbmigrations");
